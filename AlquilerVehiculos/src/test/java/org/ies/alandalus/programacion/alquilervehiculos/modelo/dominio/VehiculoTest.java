package org.ies.alandalus.programacion.alquilervehiculos.modelo.dominio;
...
public class VehiculoTest {
	...
	@BeforeEach
	void init() {
		vehiculo = new Vehiculo(MARCA_VALIDA, MODELO_VALIDO, MATRICULA_VALIDA);
	}
	...
	void constructorMarcaValidaModeloValidoCilindradaValidaMatrivaValidaCreaTurismoCorrectamente() {
		...
		vehiculo = new Vehiculo("Land Rover", MODELO_VALIDO, CILINDRADA_VALIDA, MATRICULA_VALIDA);
		vehiculo = new Vehiculo("KIA", MODELO_VALIDO, CILINDRADA_VALIDA, MATRICULA_VALIDA);
		vehiculo = new Vehiculo("Rolls-Royce", MODELO_VALIDO, CILINDRADA_VALIDA, MATRICULA_VALIDA);
		vehiculo = new Vehiculo("SsangYong", MODELO_VALIDO, CILINDRADA_VALIDA, MATRICULA_VALIDA);
	}
